...
The Ethereum layer 2 ecosystem has been expanding rapidly over the last year. The ZK-EVM rollup ecosystem, traditionally featuring [StarkNet](https://www.starknet.io/en), [Arbitrum](https://arbitrum.io/), [Optimism](https://optimism.io), and [Scroll](https://scroll.io/), has been progressing quickly, making great strides on improving their security; the [L2beat page](https://l2beat.com/scaling/summary) does a good job of summarizing the state of each project. Additionally, we have seen teams building sidechains also starting to build rollups ([Polygon](https://polygon.technology/)), layer 1 projects seeking to move toward being validiums ([Celo](https://celo.org/)), and totally new efforts ([Linea](https://linea.build/), [Zeth](https://www.risczero.com/news/zeth-release)...).
