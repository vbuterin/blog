...
La structure des catégories a été une fois de plus modifiée; cette fois-ci, divisé entre "tech DApp", "infrastructure" et "communauté". Voici les résultats :
...
* [Balancer] (https://balancer.exchange/), une bourse décentralisé
* [Synthetix] (https://synthetix.io/), une plateforme d'actifs synthétiques
* [Yann] (https://yearn.finance/), une plateforme de prêt garanti
