...
To me, the crypto space is not just about coins, and I admit my attraction to ENS does not center around some notion of _unconditional and infinitely strict_ property-like ownership over domains. Rather, my interest in the space lies more on [credible neutrality](https://nakamoto.com/credible-neutrality/), and property rights that are strongly protected particularly against politically motivated censorship and arbitrary and targeted interference by powerful actors. That said, a high degree of guarantee of ownership is nevertheless very important for a domain name system to be able to function.
